...
export default function AboutTheme() {
    ...
    return (
        <section
            ref={containerRef}
            className="relative min-h-screen lg:min-h-screen lg:max-h-screen flex flex-col lg:flex-row items-center snap-start lg:overflow-visible overflow-x-clip"
        >
            ...
            <div className="relative w-full h-full z-10 flex flex-col lg:grid lg:grid-cols-[50%_auto] items-center lg:items-left lg:justify-left">
                ...
                {/* Rickshaw - Absolute Bottom on Mobile (First in DOM), Absolute on Desktop */}
                <div className="w-full h-[45vh] absolute bottom-0 lg:absolute lg:bottom-[-15vh] lg:-right-35 lg:top-auto lg:h-[95%] lg:w-[65%] 2xl:absolute 2xl:bottom-[-20vh] 2xl:-right-35 2xl:top-auto 2xl:h-[105%] 2xl:w-[65%] z-40 pointer-events-none">
                    ...
                    <div className="absolute bottom-0 left-0 w-full h-[100px] lg:hidden bg-linear-to-b from-transparent to-[#861718]"></div>
                </div>

                {/* Text & Logo Content - Scrollable on Mobile */}
                <div className="w-full px-6 pt-32 pb-[45vh] mt-0 lg:mt-0 lg:pb-0 lg:pt-0 lg:w-full max-w-7xl mx-auto lg:mx-0 flex flex-col gap-4 lg:gap-8 relative z-20">
                    {/* Logo */}
                    ...
                    {/* Text */}
                    <div ref={textRef} style={{ fontFamily: 'var(--font-helvetica)' }} className="lg:w-[800px] 2xl:w-[900px] space-y-6 lg:space-y-6 z-20 text-center lg:text-left xl:pb-20 2xl:pb-22">
                        <p className="text-sm lg:text-lg 2xl:text-lg font-medium leading-relaxed text-gray-100 drop-shadow-md sm:text-xl sm:px-10 lg:px-0">
                        ...
                        <p className="text-sm lg:text-lg 2xl:text-lg font-medium leading-relaxed text-gray-100 drop-shadow-md sm:text-xl sm:px-10 lg:px-0 lg:w-[600px] 2xl:w-[800px]">
            ...
            <div className="hidden lg:block absolute bottom-0 left-0 w-full h-[90px] bg-linear-to-b from-transparent to-[#861718] z-40 pointer-events-none"></div>
        </section>
    );
}