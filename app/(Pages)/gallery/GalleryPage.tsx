...
import { galleryImages, GalleryImage } from '@/app/data/galleryData';
...
export default function GalleryPage() {
    ...
    // Detect Mobile Viewport & Randomize Images
    useEffect(() => {
        const checkMobile = () => setIsMobile(window.innerWidth < 768);
        checkMobile();
        window.addEventListener('resize', checkMobile);

        // Randomize Gallery Order on Mount
        // We use a simple shuffle here to give a unique layout every time
                    ...
                    >
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="relative w-full h-full max-h-[85vh] flex items-center justify-center pointer-events-auto"
