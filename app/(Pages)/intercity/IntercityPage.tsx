            ...
            <div className="relative w-full py-20 px-4 md:px-10">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-10 max-w-7xl mx-auto relative z-20">
                    ...
                    <div className="w-full lg:w-1/2 space-y-6 text-white/90">
                        <p className="text-sm md:text-lg leading-relaxed font-medium text-justify drop-shadow-md" style={{ fontFamily: 'var(--font-helvetica-neue), sans-serif' }}>
                            ...
                            <br /><br />
                            This is more than an achievement - it is a proud, defining moment for Kshitij.
                        </p>
                    </div>
