...
export default function AboutKshitij() {
    ...
    return (
        <section ref={containerRef} className="relative w-full overflow-hidden bg-[url('/About/YellowBg.png')]">
            ...
            {/* Bridge Section */}
            <div className="relative w-full h-[30vh] md:h-[80vh] -mt-75 sm:-mt-175 lg:-mt-130 z-10">
                <Image
            ...
            <div className="relative w-full bg-black py-20 px-4 md:px-16 z-40 flex flex-col items-center text-center gap-12">
                ...
                <p className="max-w-6xl text-white text-sm md:text-xl font-medium leading-relaxed tracking-wide" style={{ fontFamily: 'var(--font-poppins)' }}>
                    Every January, the city lights up with the eternal flame of Kshitij, as over 50,000 students from across India come together for this cultural extravaganza. From thrilling competitions to celebrity-filled evenings, from The Kshitij Show that takes you behind the curtain of stardom to prizes worth ₹50,00,000 and cash rewards of ₹3,00,000, Kshitij isn’t just an event. It’s an experience. It’s a vibe. It’s history in the making.
                </p>
